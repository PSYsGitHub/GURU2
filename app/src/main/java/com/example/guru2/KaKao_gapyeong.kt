...
class KaKao_gapyeong : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kakao_map_gapyeong)
        ...
        val mapPoint1 = MapPoint.mapPointWithGeoCoord(37.80374347138158, 127.52616591323867)
        customMarker1.itemName = "남이섬종합휴양지선착장"
        customMarker1.tag = 1
        ...
        val mapPoint2 = MapPoint.mapPointWithGeoCoord(37.79144537622806, 127.52518179329063)
        customMarker2.itemName = "남이섬"
        customMarker2.tag = 2
        ...
        val mapPoint3 = MapPoint.mapPointWithGeoCoord(37.79190676949096, 127.52576407165247)
        customMarker3.itemName = "고목"
        customMarker3.tag = 3
        ...
        val mapPoint4 = MapPoint.mapPointWithGeoCoord(37.82398624677823, 127.51633434840934)
        customMarker4.itemName = "조은마트"
        customMarker4.tag = 4
        ...
        val mapPoint5 = MapPoint.mapPointWithGeoCoord(37.91321220960988, 127.57668204702945)
        customMarker5.itemName = "가평조이글램핑"
        customMarker5.tag = 5
        ...
        val mapPoint6 = MapPoint.mapPointWithGeoCoord(37.88731615808026, 127.55102182104429)
        customMarker6.itemName = "화악리닭갈비"
        customMarker6.tag = 6
        ...
        val mapPoint7 = MapPoint.mapPointWithGeoCoord(37.88703669920416, 127.54912984725487)
        customMarker7.itemName = "집빵과커피 따숨"
        customMarker7.tag = 7
...
// 지도뷰의 중심좌표와 줌 레벨을 폴리라인과 마커들이 모두 보이도록 조정
    ...
    private fun showSmallDialog() {
        ...
        val dialogFragment = KaKao_gapyeong_popup()
