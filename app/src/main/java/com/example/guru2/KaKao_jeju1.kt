...
class KaKao_jeju1 : AppCompatActivity() {
    lateinit var bottomNavigationView: BottomNavigationView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.kakao_map_jeju1)
        ...
        val mapPoint = MapPoint.mapPointWithGeoCoord(33.36844115097466, 126.69245309158113)
        customMarker.itemName= "물영아리"
        customMarker.tag= 1
        ...
        val mapPoint2 = MapPoint.mapPointWithGeoCoord(33.33680582319439, 126.71822840305299 )
        customMarker2.itemName= "수망다원"
        customMarker2.tag= 1
        ...
        // 포인트 추가
        polyline.addPoint(MapPoint.mapPointWithGeoCoord(33.36844115097466, 126.69245309158113))
        polyline.addPoint(MapPoint.mapPointWithGeoCoord(33.33680582319439, 126.71822840305299 ))
