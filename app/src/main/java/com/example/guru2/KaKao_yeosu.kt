...
class KaKao_yeosu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kakao_map_yeosu)
        ...
        val mapPoint1 = MapPoint.mapPointWithGeoCoord(34.69619030388596, 127.7721122481257)
        customMarker1.itemName = "직화원조굴구이"
        customMarker1.tag = 1
        ...
        val mapPoint2 = MapPoint.mapPointWithGeoCoord(34.69508390470474, 127.77706494830055)
        customMarker2.itemName = "여수예술랜드"
        customMarker2.tag = 2
        ...
        val mapPoint3 = MapPoint.mapPointWithGeoCoord(34.69513662831566, 127.77727825712549)
        customMarker3.itemName = "카페 라피끄"
        customMarker3.tag = 3
        ...
        val mapPoint4 = MapPoint.mapPointWithGeoCoord(34.69531707967107, 127.77689796605878)
        customMarker4.itemName = "미디어아트조각공원"
        customMarker4.tag = 4
        ...
        val mapPoint5 = MapPoint.mapPointWithGeoCoord(34.70005532821203, 127.76132389664244)
        customMarker5.itemName = "진미회관"
        customMarker5.tag = 5
        ...
        val mapPoint6 = MapPoint.mapPointWithGeoCoord(34.70668072541613, 127.75913879590324)
        customMarker6.itemName = "청초수 물회"
        customMarker6.tag = 6
        ...
        val mapPoint7 = MapPoint.mapPointWithGeoCoord(34.71313741356791, 127.76411818689185)
        customMarker7.itemName = "피읖 카페"
        customMarker7.tag = 7
...
// 지도뷰의 중심좌표와 줌 레벨을 폴리라인과 마커들이 모두 보이도록 조정
        val polylinePoints = listOf(mapPoint1, mapPoint2, mapPoint3, mapPoint4, mapPoint5, mapPoint6, mapPoint7)
        ...
        layout01.setOnClickListener {
            ...
            // Use post method to ensure the layout updates correctly
    ...
    private fun showSmallDialog() {
        ...
        val dialogFragment = KaKao_yeosu_popup()
