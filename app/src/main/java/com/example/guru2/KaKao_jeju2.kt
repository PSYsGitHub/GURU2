...
class KaKao_jeju2 : AppCompatActivity() {
    lateinit var bottomNavigationView: BottomNavigationView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.kakao_map_jeju2)
        ...
        val mapPoint = MapPoint.mapPointWithGeoCoord(33.371921399306146, 126.57090088426408)
        customMarker.itemName= "사라오름"
        customMarker.tag= 1
        ...
        val mapPoint2 = MapPoint.mapPointWithGeoCoord(33.426101989364646, 126.55761065718909 )
        customMarker2.itemName= "아미헌"
        customMarker2.tag= 1
        ...
        // 포인트 추가
        polyline.addPoint(MapPoint.mapPointWithGeoCoord(33.371921399306146, 126.57090088426408))
        polyline.addPoint(MapPoint.mapPointWithGeoCoord(33.426101989364646, 126.55761065718909 ))
